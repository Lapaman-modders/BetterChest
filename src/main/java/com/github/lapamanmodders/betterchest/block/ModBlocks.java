package com.github.lapamanmodders.betterchest.block;

import com.github.lapamanmodders.betterchest.BetterChest;
import com.github.lapamanmodders.betterchest.items.ModCreativeModeTab;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> REMOTE_BLOCK = registerBlock("remote_block",
            () -> new Block(BlockBehaviour.Properties.of(Material.METAL)
                    .strength(9f).requiresCorrectToolForDrops()), ModCreativeModeTab.REMOTE_TAB);
